...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FPHIBehavior",
            url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/WIDGET/FPHIBehavior/1.0.1/FPHIBehavior.zip",
            checksum: "abb52d280b44963f37ba5ab108d5b1801c5f57eb8452dead4cfae9176500d86e"
        ),
    ]
)
