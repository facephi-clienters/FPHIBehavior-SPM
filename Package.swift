...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FPHIBehavior",
            url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/WIDGET/FPHIBehavior/1.0.5/FPHIBehavior.zip",
            checksum: "35bc18aad8cb141779d03b046c92a7e1116c1c250e470d67acee85809f435213"
        ),
    ]
)
